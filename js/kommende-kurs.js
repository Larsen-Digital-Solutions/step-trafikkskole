/* Kommende kurs – henter STEP-kurs fra data/kurs.json og rendrer liste(r).
   Datakilde: TABS kursoversikt. officeId 1253 (Drammen) / 765 (Røyken).
...
(function () {
  ...
  function renderFull(host, kurs) {
    var filters = [['alle', 'Alle'], ['drammen', 'Drammen'], ['royken', 'Røyken']];
